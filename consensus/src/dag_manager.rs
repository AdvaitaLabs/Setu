...
use crate::recent_cache::{CacheStatsSnapshot, FinalizedEventMeta, RecentEventCache};
...
impl DagManager {
    ...
    pub fn new(
        ...
        let recent_cache = Arc::new(Mutex::new(RecentEventCache::new(
            config.recent_cache_capacity,
        )));
