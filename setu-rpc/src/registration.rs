...
pub trait RegistrationHandler: Send + Sync {
    ...
    async fn get_validator_list(
        &self,
        request: GetValidatorListRequest,
...
impl RegistrationClient {
    ...
    pub async fn register_solver(
        ...
        let response = self
            .send_request(RpcRequest::RegisterSolver(request))
            .await?;
    ...
    pub async fn register_validator(
        &self,
        request: RegisterValidatorRequest,
    ) -> Result<RegisterValidatorResponse> {
        info!(
        ...
        let response = self
            .send_request(RpcRequest::RegisterValidator(request))
            .await?;
    ...
    pub async fn get_solver_list(&self, shard_id: Option<String>) -> Result<GetSolverListResponse> {
        ...
        let response = self
            .send_request(RpcRequest::GetSolverList(request))
            .await?;
    ...
    pub async fn get_validator_list(&self) -> Result<GetValidatorListResponse> {
        ...
        let response = self
            .send_request(RpcRequest::GetValidatorList(request))
            .await?;
    ...
    pub async fn get_node_status(&self, node_id: String) -> Result<GetNodeStatusResponse> {
        ...
        let response = self
            .send_request(RpcRequest::GetNodeStatus(request))
            .await?;
