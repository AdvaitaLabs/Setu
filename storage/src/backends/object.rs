...
use setu_types::{
    AccountView, Address, Coin, CoinType, Credential, ObjectId, Profile, RelationGraph, SetuResult,
    SubnetId, UserRelationNetworkObject, UserSubnetActivity,
};
...
pub trait ObjectStore {
    ...
    fn get_user_all_subnet_activities(&self, user: &Address)
